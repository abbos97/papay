class Definer {
    ...
    static product_error1 = "att: product creation is failed!";

     /*  order related errors  */
     static order_error1 = "att: order creation is failed!";
     static order_error2 = "att: order item creation is failed!";
}
